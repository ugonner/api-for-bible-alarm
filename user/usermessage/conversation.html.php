...
<div class="col-md-6">
    ...
    <div>
        <p>
        <div class="row">
            <a class="text-capitalize" href='/bona/user/index.php?guid=<?php echo $conversation[$i]["senderid"];?>'>
        ...
        <p>
                <a href='/bona/user/usermessage/index.php?deletemessage&mid=<?php echo($conversation[$i][0]);?>&rid=<?php echo($conversation[$i]["receiverid"]);?>'>
    ...
    <?php endfor;?>
    <div class="form-group">
        <form action="/bona/user/usermessage/index.php" method="post"
              class="form-group">
            <div class="form-group">
                <input type='hidden' name='pgn' value='<?php echo $pgn;?>'/>
    ...
    <div class="col-md-6">
        ...
        <a href="/bona/user/usermessage/index.php?getinboxmessages">
...
<?php include_once $_SERVER['DOCUMENT_ROOT'].'/bona/includes/htmlpages/footer.html.php';?>
