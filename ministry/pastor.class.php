...
class Ministry{
    ...
    public function getPastor($ministryid){
        $sql = "SELECT ministry.id AS ministryid, name AS ministryname, ministry.address, ministry.profilepic,
                ministry.about as about, user.firstname, user.surname
                FROM ministry INNER JOIN user ON ministry.overseer.id
    ...
    public function getMinistries(){
        ...
        $sql = "SELECT ministry.id AS ministryid, ministry.name AS ministryname
                FROM ministry ORDER BY pastor.id DESC";
...
//add pastor;
    public function addMinistry($name,$address,$overseerid, $about){
        ...
        $sql = "9INSERT INTO ministry (name, address, overseerid, about) VALUES (:name, :address, :overseerid, :about)";
